...
//        String searchType = request.getParameter("search-type")== null ? "1" : request.getParameter("search-type");
...
//        }
        ArrayList<Subject> sList = s.getSubject(search, searchType);
        request.setAttribute("subject", sList);
        request.getRequestDispatcher("subjectList.jsp").forward(request, response);
    }
