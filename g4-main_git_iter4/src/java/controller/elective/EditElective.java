...
public class EditElective extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Elective c = dao.getELective(cid);
        request.setAttribute("c", c);
        request.getRequestDispatcher("./elective/edit.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.editELective(name, subject, id);
        response.sendRedirect("ListElective");
    }
