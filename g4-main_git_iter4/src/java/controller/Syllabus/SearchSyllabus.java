 ...
 * @author 84379
 */
@WebServlet(name = "SearchSyllabus", urlPatterns = {"/SearchSyllabus"})
public class SearchSyllabus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
//            sSearch = request.getParameter("searchSyllabus");
//            String indexString = request.getParameter("index");
//            int index = Integer.parseInt(indexString);
//            
//            SyllabusDAO dao = new SyllabusDAO();
//            int count = dao.countSyllabus(sSearch);
//            int pagesize = 5;
//            int endPage = 0;
...
//            }
//            
//            List<Syllabus> listSyllabus = dao.SearchSy(sSearch, index, pagesize);
//            
