                    ...
                    <div class="tab-pane fade show active" id="nav-question" role="tabpanel" aria-labelledby="nav-question-tab">
                        <div style="margin-top: 1rem;">
                            <div style="display: flex; justify-content: center">
                                <form method="post" action="addQuestion" style="padding: 5px; width: 95%">
                                    <input type="text" name="syllabusID" value="${requestScope.syllabusID}" hidden>
                                    <input type="text" name="qid" value="${requestScope.qid}" hidden>
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <label style="font-weight: bold">Session No: <span style="color:red;">*</span></label>
                                            <input type="text" name="sessionNo" class="form-control" required>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <textarea id="question_details" style="height: 250px"e="text" name="qDetail" class="form-control"></textarea>
                                    </div>
