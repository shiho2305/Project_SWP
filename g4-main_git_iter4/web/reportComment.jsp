            ...
            <div class="row d-flex justify-content-center mt-50 mb-100">
                <div class="col-lg-12" style="border: 1px solid lightgray; border-radius: 1rem;">
                    <div class="card">
                        ...
                        <form method="get" action="viewreportComment">
                                ...
                                <div class="comment-widgets">
                                    ...
                                    <div class="d-flex flex-row comment-row m-t-0 row">
                                        ...
                                        <div class="comment-text w-100 col-md-11">
                                            ...
                                            <!--                                            <span class="m-b-15 d-block" style="font-family: cursive; color: red">
                                            ${c.reportDescription}
                                        </span>-->
                                            <span>
                                                <c:if test="${c.report == 'valid'}">
                                                    <span class="m-b-15 d-block" style="font-family: cursive; color: green">
                                                        ${c.reportDescription}
                                                    </span>
                                                </c:if>
                                                <c:if test="${c.report == 'invalid'}">
                                                    <span class="m-b-15 d-block" style="font-family: cursive; color: red">
                                                        ${c.reportDescription}
                                                    </span>
                                                </c:if>
                                            ...
                                            <div class="comment-footer">
                                                <a href="updateComment?id=${c.id}"><i class="fa fa-pencil-square-o fa-lg"></i></a>
                                                    <c:if test="${sessionScope.roleName == 'admin' || sessionScope.roleName == 'head_of_crdd'}">
                                                ...
                                                <span>
                                                    <c:if test="${c.report == 'valid'}">
                                                        <small class="rounded ml-2" style="background-color: lightgreen; padding: 1.5px 3px">Valid</small>
                                                    </c:if>
                                                    <c:if test="${c.report == 'invalid'}">
                                                        <small class="rounded ml-2" style="background-color: lightcoral ;padding: 1.5px 3px">Invalid</small>
                                                    </c:if>
                                                </span>
                                            </div>
                                        </div>
