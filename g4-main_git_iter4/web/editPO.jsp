            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="#">Update LO</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="tab-pane fade show active" id="nav-PO" role="tabpanel" aria-labelledby="nav-PO-tab">
                        <div style="margin-top: 1rem;">
                            <div style="display: flex; justify-content: center">
                                <form method="post" action="EditPO" style="padding: 5px; width: 95%">
                                    <input type="text" name="cloName" value="${p.cloName}" hidden>
                                    <input type="text" name="syllabusID" value="${p.syllabusID}" hidden>
                                    <div class="mt-3">
                                        <label style="font-weight: bold">CLO Details: <span style="color:red;">*</span></label>
                                        <input type="text" name="cloDetails" value="${p.cloDetails}" class="form-control" required>
                                    </div>

                                    <div class="mt-3">
                                        <label style="font-weight: bold">LO Details: <span style="color:red;">*</span></label>
                                        <textarea id="loDetails" style="height: 250px"e="text" name="loDetails" class="form-control" required>${p.loDetails}</textarea>
                                    </div>

                                    <div class="d-flex justify-content-around" style="margin-top: 2rem;">
                                        <a href="SyllabusDetail?sid=${p.syllabusID}">
                                            <button class="btn-52">
