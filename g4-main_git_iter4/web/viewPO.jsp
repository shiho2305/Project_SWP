...
<html>
    ...
    <body>
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="#">PO Details</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <!--        <div class="float-start ml-5 mb-2">
        ...
        <div style="width: 95%; margin-left: 3rem; margin-top: 2rem">
            ...
            <div class="float-start ml-1 mb-2">
                <p style="color: blueviolet; font-weight: bold">Total LO: ${requestScope.count}</p>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach items="${list}" var="p">
                            <tr>
                                <td style="text-align: center">${p.cloName}</td>
                                <td style="text-align: center">${p.cloDetails}</td>
                                <td>${p.loDetails}</td>
                                <c:if test="${sessionScope.roleName == 'head_of_crdd' || sessionScope.roleName == 'staff_of_crdd'}">
                                    <td class="d-flex">
                                        <a id="update" href="EditPO?cloName=${p.cloName}" style="color:black"><i class="fa fa-pen-to-square fa-lg"></i></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a id="delete" style="color:black" onclick="messageSuccessPO(${p.cloName})"><i class="fa fa-trash fa-lg"></i></a>
                                    </td>
                                </c:if>
                            </tr>
                        </c:forEach>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item <c:if test="${index==1}">disabled
                                ...
                                <a class="page-link" href="viewPO?sid=${sid}&index=${index-1}" >Previous</a>
                            </li>
                            <li class="page-item active">
                                <a class="page-link" href="viewPO?sid=${sid}&index=${index}" style="color: white;">${index}</a>
                            </li>
                            <li class="page-item <c:if test="${index==numberPage+1}">disabled　
                                </c:if>">
                                <a class="page-link" href="viewPO?sid=${sid}&index=${index+1}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <script>
                                            function messageSuccessPO(cloName) {
                                                var option = confirm('Are you sure to delete?');
                                                if (option === true) {
