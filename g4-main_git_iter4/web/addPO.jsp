                    ...
                    <div class="tab-pane fade show active" id="nav-PO" role="tabpanel" aria-labelledby="nav-PO-tab">
                        <div style="margin-top: 1rem;">
                            <div style="display: flex; justify-content: center">
                                <form method="post" action="AddPO" style="padding: 5px; width: 95%">
                                    <input type="text" name="syllabusID"  value="${requestScope.syllabusID}" class="form-control" hidden>
                                    <div class="mt-3">
                                        <label style="font-weight: bold">CLO Details: <span style="color:red;">*</span></label>
                                        <input type="text" name="cloDetails" class="form-control" required>
                                    </div>

                                    <div class="mt-3">
                                        <label style="font-weight: bold">LO Details: <span style="color:red;">*</span></label>
                                        <textarea id="loDetails" style="height: 250px" type="text" name="loDetails" class="form-control" required></textarea>
                                    </div>
